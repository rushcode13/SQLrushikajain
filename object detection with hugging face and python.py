...
HF_API_KEY="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"
...
def ask_image():
    ...
    while True:
        ...
        if os.path.getsize(p)/(1024*1024) > MAX_MB: print(" tooo big(>8MB)."); continue
...
def main():
    ...
    print("Derection may not always be accurate")
